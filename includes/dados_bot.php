...
define ('PORCENTAGEM_LUCRO', 85); // %

// lista de ids de adms
define ('ADMS', [1666563554]);

define ('CHAT_ID_NOTIFICACAO', '-1666563554'); // onde irá as notificações de resgate de saldos (opcional)

define ('GRUPO_ID','-1666563554'); // grupo de bot
